...
public class Controller implements Initializable {
	...
	private ArrayList<Integer> ints = new ArrayList<Integer>();// temp storage
																// for added
																// tree ints
	private Circle[] c, c1;
	private Text[] t, t1;
	...
	public void addNumber1(ActionEvent event) {
		...
		if (!tree1.contains(temp)) {
			...
			ints.add(temp); // add number to array
	...
	public void getSubtree(ActionEvent event) {
		...
		if (tree1.root != null) { // clear previous tree
			...
			tree1.root = null;
			arrayPos1 = 0;
			ints.clear(); // clear the array of ints
...
//			int index = 0;
//			for (int i = 0; i < ints.size(); i++) {// obtain index of number in
//													// del box
//				if (ints.get(i) == del) {
//					index = i;
//				}
...
//				arrayPos1 = 0;
//			}
//			for (int i = 0; i < ints.size(); i++) {// recreate tree without
//													// deleted node
//				add1(ints.get(i));
//			}
//		}
...
//	}
	...
	public void q4Answer(ActionEvent event) {
		...
		if (q4Ans.getText().equals("10 16 25")
				|| q4Ans.getText().equals("10 25 16")) {
			xMark.setVisible(false);
			checkMark.setVisible(true);
